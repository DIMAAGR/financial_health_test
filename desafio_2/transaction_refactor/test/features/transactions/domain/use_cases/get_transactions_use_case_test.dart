...
void main() {
  ...
  group('GetTransactionsUseCase', () {
    test('deve retornar Right com lista e total líquido correto (receitas - despesas)', () async {
      // Arrange: 500000 + 80000 - 150000 - 32050 = 397950 centavos
      repository.mockSuccess([income(500000), expense(150000), expense(32050), income(80000)]);
    ...
    test('deve retornar total positivo quando todas as transações são receitas', () async {
    ...
    test('deve retornar total negativo quando despesas superam receitas', () async {
    ...
    test('deve propagar ServerFailure quando o repositório falha com erro de servidor', () async {
    ...
    test('deve chamar o repositório exatamente uma vez por invocação', () async {
      repository.mockSuccess([]);
